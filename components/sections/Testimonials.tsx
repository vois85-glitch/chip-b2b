...
const testimonials = [
 {
 quote: "Искали редкие ПЛИС для срочного заказа. ChipNet нашли аналоги и доставили за неделю. Спасли запуск серии.",
 name: "Алексей В.",
...
export default function Testimonials() {
 ...
 <p className="text-[#555] text-lg">Отзывы инженеров и руководителей закупок</p>
 </div>
 ...
 className="bg-[#f0f4ee] border border-[#e8e8e8] rounded-xl p-5 shadow-sm"
 >
