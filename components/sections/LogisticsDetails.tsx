...
export default function LogisticsDetails() {
  return (
    <section className="py-6 px-4 bg-white dark:bg-[#0f1210]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {details.map((item, index) => (
            <motion.div 
              ...
              className="bg-white dark:bg-[#1a1f1c] border border-[#e8e8e8] dark:border-[#2a3530] rounded-lg p-3 shadow-sm hover:shadow-md transition-shadow"
            >
