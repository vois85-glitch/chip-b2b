    ...
    <section id="bom" className="py-6 px-4 bg-section-alt relative overflow-hidden">
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-6">
          <h2 className="text-xl md:text-2xl font-bold mb-2 text-[#121212] dark:text-white">Запрос коммерческого предложения</h2>
          <p className="text-[#666] dark:text-[#8a9a94] text-sm">Загрузите BOM-лист или опишите необходимые компоненты</p>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
            <div>
              <label className="block text-xs font-medium text-[#333] dark:text-[#c4d0ca] mb-1">Компания</label>
              <input 
                type="text" 
                name="company_name"
                required
            ...
            <div>
              <label className="block text-xs font-medium text-[#333] dark:text-[#c4d0ca] mb-1">ИНН</label>
              <input 
                type="text" 
                name="inn"
                required
            ...
            <div>
              <label className="block text-xs font-medium text-[#333] dark:text-[#c4d0ca] mb-1">Email</label>
              <input 
                type="email" 
                name="email"
                required
            ...
            <div>
              <label className="block text-xs font-medium text-[#333] dark:text-[#c4d0ca] mb-1">Телефон</label>
              <input 
                type="tel" 
                name="phone"
                className="w-full bg-[#eaf0e8] border border-[#e8e8e8] dark:border-[#2a3530] rounded-lg px-3 py-2 text-sm text-[#121212] dark:text-white placeholder-[#999] focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors"
          ...
          <div className="mb-3">
            <label className="block text-xs font-medium text-[#333] dark:text-[#c4d0ca] mb-1">Список компонентов или комментарий</label>
            <textarea 
              name="message"
              rows={3}
          ...
          <div className="mb-4">
            <label className="block text-xs font-medium text-[#333] dark:text-[#c4d0ca] mb-1">Прикрепить BOM-лист</label>
            <div className="flex items-center justify-center w-full">
              <label className="flex flex-col items-center justify-center w-full h-20 border-2 border-dashed border-[#cbcbcb] rounded-xl cursor-pointer hover:bg-section-alt hover:border-primary/50 transition-all">
                <div className="flex flex-col items-center justify-center py-2">
                  ...
                  <p className="text-xs text-[#666] dark:text-[#8a9a94]">
