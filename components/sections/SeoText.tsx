export default function SeoText() {
 ...
 <p>
 Компания <strong className="text-[#121212]">ООО «Деловой Партнёр» (ChipNet)</strong> — это прямой поставщик оригинальных электронных компонентов и промышленной автоматики. Мы специализируемся на обеспечении предприятий НИИ и производств радиоэлектронной аппаратуры критически важными комплектующими.
 </p>
 <p>
