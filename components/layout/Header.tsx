    ...
    >
      ...
      <div className={`transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          {/* Логотип */}
          <Link href="/" onClick={handleLogoClick} className="flex items-center gap-2.5 group cursor-pointer shrink-0">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[10px] text-[#999] tracking-wide">ЭЛЕКТРОННЫЕ КОМПОНЕНТЫ</div>
            </div>
          </Link>

          {/* Бейдж — только с юрлицами */}
          <div className="hidden lg:inline-flex items-center gap-1.5 px-3 py-1 bg-[#f5f5f5] rounded-full text-xs text-[#666]">
          ...
          <div className="hidden md:flex items-center gap-5">
            <a href="tel:+79103219191" className="flex items-center gap-2 text-sm text-[#333] hover:text-primary transition-colors">
              <svg className="w-4 h-4 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <span className="font-medium">+7-910-321-91-91</span>
            </a>
            <a href="mailto:info@chip-net.ru" className="flex items-center gap-2 text-sm text-[#333] hover:text-primary transition-colors">
              <svg className="w-4 h-4 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="flex items-center gap-3">
            <Link href="/catalog" className="hidden sm:inline-flex bg-primary hover:bg-primary-dark text-white px-5 py-2 rounded-full text-sm font-semibold transition-all hover:shadow-lg hover:shadow-primary/25">
              Обратный звонок
            </Link>
      ...
      <div className="bg-[#1e2a25]">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-11 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2 text-white/50 text-xs">
            ...
            Поставка по всей России от 6 дней
          </div>
        </nav>
      </div>
