...
export const metadata: Metadata = {
  title: 'База знаний — статьи и руководства по электронным компонентам | ChipNet',
...
const additionalLinks = [
  ...
  },
  {
    ...
    description: 'Компоненты для ВПК, автоматики, медицины и других отраслей',
    href: '/industries',
  },
];
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-[#333] leading-relaxed">
              <p>
                ...
                работающих с электронными компонентами для промышленности и оборонного комплекса.
