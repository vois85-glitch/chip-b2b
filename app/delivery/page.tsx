...
export const metadata: Metadata = {
  ...
  description: 'Условия доставки и оплаты электронных компонентов. Самовывоз и доставка по всей России (Деловые линии, СДЭК). Безналичный расчёт, частичная оплата, отсрочка платежа для постоянных клиентов.',
  alternates: {
    canonical: `${BASE_URL}/delivery`,
  },
  openGraph: {
    title: 'Доставка и оплата — условия поставки электронных компонентов | ChipNet',
    description: 'Условия доставки и оплаты электронных компонентов. Самовывоз и доставка по всей России. Безналичный расчёт, частичная оплата, отсрочка платежа.',
...
const deliveryMethods = [
  ...
  },
  {
    icon: '🏢',
    title: 'Самовывоз',
    description: 'Заберите товар самостоятельно со склада в Белгороде. Мы подготовим все необходимые документы (УПД, сертификаты, отчёты о входном контроле) и обеспечим комфортный процесс получения заказа.',
  },
  {
    icon: '🚚',
...
const faqItems = [
  {
    ...
    answer: 'Отправка осуществляется в течение 1–2 рабочих дней после поступления оплаты, при условии наличия товара на складе. Если товар находится на нашем складе в Белгороде, возможна отгрузка в день оплаты. Для заказных позиций сроки зависят от логистической цепочки и обсуждаются с менеджером при оформлении заказа.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Да, вы можете забрать товар самостоятельно со склада в Белгороде. Мы подготовим все необходимые документы и обеспечим комфортный процесс получения. Самовывоз доступен после подтверждения готовности заказа — обычно в тот же день или на следующий рабочий день после оплаты.',
  },
];
