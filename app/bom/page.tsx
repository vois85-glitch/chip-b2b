...
export const metadata: Metadata = {
  title: 'BOM-комплектация производств — поставка электронных компонентов | ChipNet',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: 'УПД с НДС, сертификаты происхождения, отчёты о входном контроле, таможенные декларации для импортных компонентов. Вся документация в формате ЭДО. Соответствие требованиям бухгалтерии и ВПК.',
                },
              ].map((item) => (
                <div
                  key={item.title}
