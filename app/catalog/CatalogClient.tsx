...
export default function CatalogClient({
  ...
  const filterSidebar = (
    <>
      {/* Categories */}
      <div className="bg-[#eaf0e8] border border-[#e8e8e8] rounded-xl p-4 mb-4">
          ...
          <form onSubmit={handleSearch} className="flex gap-2 sm:gap-3">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-4 sm:px-5 py-3 sm:py-3.5 bg-[#f0f4ee] border border-[#e8e8e8] rounded-xl text-[#121212] placeholder-[#999] focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-all text-sm sm:text-base"
              />
              {searchInput && (
                <button
                  type="button"
              ...
              <div className={`grid gap-3 ${showFilters ? 'grid-cols-1 sm:grid-cols-2 xl:grid-cols-3' : 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'}`}>
                {components.map((comp) => (
                  <Link
                    ...
                    className="group block bg-[#e0e8de] border border-[#e8e8e8] rounded-xl p-4 hover:bg-[#d5e0d3] hover:border-emerald-800/50 transition-all duration-200"
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 bg-[#d5e0d3] rounded text-[10px] text-[#757575]">
                        {comp.brand}
                      </span>
                      <span className="px-2 py-0.5 bg-[#d5e0d3] rounded text-[10px] text-[#757575]">
                        {comp.category}
        ...
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-[85vw] max-w-sm bg-[#0a0d0c] border-r border-[#e8e8e8] flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#e8e8e8]">
              ...
              <button
                onClick={() => setShowFilters(false)}
                className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-[#eaf0e8] text-[#666] hover:text-[#121212] transition-colors"
              >
