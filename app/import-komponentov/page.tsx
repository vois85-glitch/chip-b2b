...
const importCategories = [
 ...
 description: 'Analog Devices, Texas Instruments, Maxim — высокоточные преобразователи и усилители для измерительных систем, автоматики.',
 },
 {
...
export default function ImportKomponentovPage() {
 ...
 Срочная авиадоставка от 6 рабочих дней. Работаем с B2B-клиентами: промышленные предприятия, разработчики электроники.
 </p>
 </div>
 </section>
 ...
 <p className="text-[#666] mb-12 max-w-2xl">
 Полный ассортимент электронных компонентов для промышленности — от пассивных элементов до сложных систем-на-кристалле.
 </p>
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
