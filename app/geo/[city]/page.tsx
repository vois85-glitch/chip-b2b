...
export default async function GeoPage({ params }: Props) {
 ...
 <div className="bg-[#e0e8de] rounded-xl border border-[#e8e8e8] p-6 md:p-8">
 ...
 key={cat.slug}
 href={`/${cat.slug}`}
 className="bg-[#e0e8de] hover:bg-[#dce6da] border border-[#e8e8e8] hover:border-[#cbcbcb] rounded-lg p-4 text-center transition-all"
 >
 ...
 <div className="bg-[#e0e8de] rounded-xl border border-[#e8e8e8] p-6">
