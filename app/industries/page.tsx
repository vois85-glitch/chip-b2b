...
export const metadata: Metadata = {
 title: 'Отраслевые решения — электронные компоненты для промышленности | ChipNet',
 description: 'Отраслевые решения для промышленности, промышленной автоматики, телекоммуникаций, энергетики, медицины, автомобилестроения, аэрокосмической отрасли и потребительской электроники.',
 alternates: {
 canonical: `${BASE_URL}/industries`,
 },
 openGraph: {
 title: 'Отраслевые решения — электронные компоненты для промышленности | ChipNet',
 description: 'Отраслевые решения для промышленности, промышленной автоматики, телекоммуникаций, энергетики, медицины, автомобилестроения, аэрокосмической отрасли.',
...
const industries: Industry[] = [
 ...
 requirements: 'Радиационная стойкость, расширенный температурный диапазон, промышленные стандарты-883, высокая наработка на отказ',
...
const faqItems = [
 {
 question: 'Работаете ли вы с промышленными предприятиями?',
 answer: 'Да, мы имеем опыт работы с предприятиями промышленности. Поставляем компоненты с повышенной надёжностью, обеспечиваем полное прослеживание происхождения каждого компонента, оформляем необходимые разрешения и лицензии для специализированных компонентов. Все компоненты проходят входной контроль в аккредитованной лаборатории СВП.',
 },
 {
...
const organizationLd = {
 ...
 url: BASE_URL,
 description: 'Поставщик электронных компонентов для промышленности, промышленной автоматики, телекоммуникаций, энергетики, медицины и других отраслей.',
...
export default function IndustriesPage() {
 ...
 Поставка электронных компонентов для ключевых отраслей промышленности: от
 ...
 нашей работы с предприятиями промышленности.
 </p>
 ...
 description: 'Аккредитованная лаборатория входного контроля для подтверждения оригинальности и параметров компонентов. Рентген, декэпсуляция, электрические тесты и визуальный контроль. Особенно критично для аэрокосмического сектора.',
 },
 {
 ...
 description: 'Таможенное оформление, экспортные лицензии для специализированных компонентов, сертификаты происхождения. Работаем с компонентами всех категорий, включая специальные разрешения для промышленности.',
 },
 {
 ...
 description: 'УПД с НДС, сертификаты происхождения, отчёты о входном контроле, таможенные декларации. Документация в формате ЭДО. Соответствие требованиям бухгалтерии и государственных заказчиков.',
 },
 ].map((item) => (
 <div
 key={item.title}
